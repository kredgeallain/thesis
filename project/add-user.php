...
<section class="col">
    <section class="log-in">
        <div class="text2">
            <p><b><svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor"
                        class="bi bi-person-fill-add" viewBox="0 2 20 16">
                        <path
                            d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm.5-5v1h1a.5.5 0 0 1 0 1h-1v1a.5.5 0 0 1-1 0v-1h-1a.5.5 0 0 1 0-1h1v-1a.5.5 0 0 1 1 0Zm-2-6a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                        <path
                            d="M2 13c0 1 1 1 1 1h5.256A4.493 4.493 0 0 1 8 12.5a4.49 4.49 0 0 1 1.544-3.393C9.077 9.038 8.564 9 8 9c-5 0-6 3-6 4Z" />
                    </svg>User Registration</b></p>
        </div>
        <?php
      	  if(isset($_GET['add'])){
			$add = $_GET['add'];
			if($add=='success'){
				echo ' <div class ="d-flex justify-content-center"> <span class="alert alert-success">User Successfully Added</span> </div>';
			}
                        ...
                        <div class="p-3 bg-transparent">
                            ...
                            <div class="input2">
                                <select class="form-select" aria-label="Default select example" name="position"
                                    id="position" placeholder="Select Position" required="true">
                        ...
                        <div class="p-3 bg-trnsparet">
                            ...
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="mobile_no" name="mobile_no"
                                    placeholder="09890138761" required="true">
