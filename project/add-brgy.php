...
if ($result = $data->query($query)){
        ...
        <div class="addbatch-button">
          ...
          <a type="button" class="btn btn-info" href= "view-farmx.php?baranggayID='.$row['baranggayID'].'"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 20 20">
