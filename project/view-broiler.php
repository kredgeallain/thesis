...
<th scope='col' id='u-name'> Rejected </th>
<th scope='col' id='u-name'> Harvested </th>
...
<th scope='col' id='u-name'> Recorded by </th>
    ...
    while($row = $result->fetch_assoc()){
        ...
        if ($new_mortality_rate >= $rate ) {
            ...
            <a href="view-production.php?batchID='.$row['batchID'].'&month='.$month_letter.'&year='.$row['year'].'"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-eye" viewBox="0 0 20 20">
