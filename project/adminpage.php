        ...
        <section class="farm">
            <details>
                ...
                <section class="farm-dropdown">
                    <ul>
                        <li><a href="view-farm.php"><img src="../image/view-farm.png" height="20%" width="20%">VIEW
                                FARM</a></li>
                        <li><a href="add-farm.php"><img src="../image/add-farm.png" height="20%" width="20%">ADD
                                FARM</a></li>
                        <li><a href="map.html"><img src="../image/mortality-rate2.png" height="20%" width="20%">VIEW
                                FARM MAP</a></li>
                    </ul>
                </section>
            </details>
        ...
        <section class="user">
            <details>
                ...
                <section class="user-dropdown">
                    <ul>
                        <li><a href="add-user.php"><img src="../image/add-user2.png" height="40%" width="25%">ADD
                                USERS</a></li>
                        <li><a href="view-user.php"><img src="../image/view-user.png" height="30%" width="20%">VIEW
                                USERS</a></li>
                    </ul>
                </section>
            </details>
